...
@section('content')
    <div class="card">
        <div class="card-body">
            <form id="categoryForm" action="{{ route('instructor.update',$instructor->id) }}" method="POST"
                ...
                <div class="form-group mb-3">
                    <label for="src">
                        <img id="imagePreview" src="{{ asset('files/instructors/'.$instructor->src) }}"
                             alt="{{ $instructor->alt }}"
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <input type="url" name="facebook" id="facebook" class="form-control"
                                   value="{{ old('alt',$instructor->facebook) }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <input type="url" name="instagram" id="instagram" class="form-control"
                                   value="{{ old('alt',$instructor->instagram) }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="profession" id="profession" class="form-control"
                           value="{{ old('alt',$instructor->profession) }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" name="order_no" id="order_no"
                           class="form-control" value="{{ $instructor->order_no }}">
...
@section('js')
    ...
    <script>
        $('#saveCategory').click(function (e) {
            ...
            $.ajax({
                url: '{!! route('instructor.update',$instructor->id) !!}',
                data: data,
                cache: false,
                processData: false,
                contentType: false,
