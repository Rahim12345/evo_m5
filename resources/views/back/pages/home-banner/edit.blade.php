    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('home-banner.update',['home_banner'=>$homeBanner->id]) }}" method="POST"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="form-select mb-3" id="locale" name="locale">
                                        @foreach(config('app.languages') as $locale_code => $locale_name)
                                            <option
                                                value="{{$locale_code}}"
                                                @selected(old('locale', $homeBanner->locale) == $locale_code)
                                            >
                                                {{ $locale_name }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="src" class="form-label">
                                        <img id="imagePreview" src="{{ asset('files/home_banners/'.$homeBanner->src) }}"
                                             alt="Preview" style="cursor:pointer;width: 150px" title="Şəkil seçin">
                                    </label>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @error('alt')
                                       is-invalid
                                    @enderror
                                    " id="alt" name="alt" value="{{ old('alt',$homeBanner->alt) }}"
                                    >
                                    @error('alt')
                                    <small class="text-danger" role="alert">
                                        {{ $message }}
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @error('main_heading')
                                       is-invalid
                                    @enderror" id="main_heading" name="main_heading"
                                           value="{{ old('main_heading',$homeBanner->main_heading) }}"
                                    >
                                    @error('main_heading')
                                    <small class="text-danger" role="alert">
                                        {{ $message }}
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    @error('title')
                                       is-invalid
                                    @enderror" id="title" name="title" value="{{ old('title',$homeBanner->title) }}">
                                    @error('title')
                                    <small class="text-danger" role="alert">
                                        {{ $message }}
                                    </small>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    >{{ old('intro_text',$homeBanner->intro_text) }}</textarea>
                                    @error('intro_text')
                                    <small class="text-danger" role="alert">
                                        {{ $message }}
                                    </small>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @enderror" id="button_text_1" name="button_text_1"
                                           value="{{ old('button_text_1',$homeBanner->button_text_1) }}"
                                    >
                                    @error('button_text_1')
                                    <small class="text-danger" role="alert">
                                        {{ $message }}
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @enderror" id="button_link_1" name="button_link_1"
                                           value="{{ old('button_link_1',$homeBanner->button_link_1) }}"
                                    >
                                    @error('button_link_1')
                                    <small class="text-danger" role="alert">
                                        {{ $message }}
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @enderror" id="button_text_2" name="button_text_2"
                                           value="{{ old('button_text_2',$homeBanner->button_text_2) }}"
                                    >
                                    @error('button_text_2')
                                    <small class="text-danger" role="alert">
                                        {{ $message }}
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @enderror" id="button_link_2" name="button_link_2"
                                           value="{{ old('button_link_2',$homeBanner->button_link_2) }}"
                                    >
                                    @error('button_link_2')
                                    <small class="text-danger" role="alert">
                                        {{ $message }}
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary float-end" name="save_to_list">
                                        <i class="fa fa-save"></i>
                                    </button>

                                    <button type="submit" class="btn btn-success float-end" name="save_to_editing">
